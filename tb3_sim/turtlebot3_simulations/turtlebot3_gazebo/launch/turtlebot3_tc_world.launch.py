...
def generate_launch_description():
    ...
    world_file_name = 'turtlebot3_tc.world'
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{'frame_prefix': entity_name+'/', 'use_sim_time': use_sim_time, 'robot_description': Command(['xacro ', robot_desc_path, ' robot_name:=', entity_name])}],
            output="screen"
        )
